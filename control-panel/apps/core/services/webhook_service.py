...
class WebhookService:
    ...
    def process_github_webhook(
        ...
        try:
            ...
            from apps.deployments.shared.service_manager import ServiceManager
    ...
    def list_user_webhooks(self, user: User) -> List[Dict[str, Any]]:
        """
    ...
    def get_recent_deliveries(self, webhook: Webhook, limit: int = 10) -> List[Dict[str, Any]]:
        """
