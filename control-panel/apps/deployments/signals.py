...
def deployment_status_changed(sender: type, instance: BaseDeployment, created: bool, **kwargs: Any) -> None:
    ...
    message = {
        ...
        'deployment': {
            ...
            'project_type': instance.project_type if isinstance(instance, ApplicationDeployment) else None,
            'repo_url': instance.repo_url if isinstance(instance, ApplicationDeployment) else None,
            'branch': instance.branch if isinstance(instance, ApplicationDeployment) else None,
