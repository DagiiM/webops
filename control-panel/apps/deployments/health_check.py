...
Reference: CLAUDE.md "Service Monitoring" section
"""
...
class AutoRestartService:
    ...
    def should_auto_restart(self) -> Tuple[bool, str]:
        ...
        if self.deployment.status != Deployment.Status.RUNNING:
            return False, f'Deployment status is {self.deployment.status}, not running'
...
def perform_health_check(deployment: Deployment, auto_restart: bool = True) -> Dict[str, Any]:
    """
