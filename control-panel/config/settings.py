...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates', BASE_DIR / 'apps' / 'addons' / 'templatetags'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
MIN_PORT = config('MIN_PORT', default=8001, cast=int)
MAX_PORT = config('MAX_PORT', default=9000, cast=int)
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': BASE_DIR / 'logs' / 'webops.log',
