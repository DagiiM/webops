...
print_completion_message() {
    ...
    echo ""
    echo -e "${YELLOW}If Services Are NOT Running:${NC}"
    echo "  sudo systemctl start webops-web webops-worker webops-beat"
    echo "  sudo systemctl enable webops-web webops-worker webops-beat"
    echo ""
    echo -e "${YELLOW}Next Steps:${NC}"
    echo "  1. Verify services are running (see commands above)"
    echo "  2. Access the control panel in your browser"
